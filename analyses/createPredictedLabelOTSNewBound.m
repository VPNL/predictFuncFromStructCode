...
for s=[1 3 4 6 7 9 10 12 15 17 19 20 21 23 24 25 26 27 28 29]
    for r=1:length(ROIs)
        ...
        label(:,5)=predictedLabelBinary(:,1);
        ...
        write_label(predctionLabel(:,1), predctionLabel(:,2:4), predctionLabel(:,5),fullfile(strcat('Subject_',num2str(s),'_predicted_',ROIs{r},'_roi_',kernel{:},'_',predictors{:},'.label')));
    end
end
