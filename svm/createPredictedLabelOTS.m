...
for r=1:length(ROIs)
    ...
    load(strcat('RBF_Subject_',num2str(s),'_',ROIs{r},'_roi_output.mat'));
    ...
    write_label(predctionLabel(:,1), predctionLabel(:,2:4), predctionLabel(:,5),fullfile(strcat(ROIs{r},'_RBF_readPredicted.label')));
