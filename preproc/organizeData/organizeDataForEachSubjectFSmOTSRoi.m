...
maps={'lh_mOTS_morphing_reading_vs_all' '01_adding_vs_all' '02_reading_vs_all' '03_T1_in_GM' '03_T1_in_WM' 'Group_lh_mOTS_morphing_reading_vs_all_proj_max_without_Subject_'};
...
for s=1:30
    ...
    cd(outFolder)
    save(strcat('Subject_',num2str(s),'_','lh_mOTS_fsavg_roi.mat'),...
