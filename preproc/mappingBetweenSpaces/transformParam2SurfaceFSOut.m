...
for ss = 3:30
    ...
    outDir=fullfile(surf_dir,'predictFuncFromStruct');
    mkdir(outDir);
    ...
    for mm = 1:length(map_names)
        ...
        unix(['mri_convert -ns 1 -odt float -rt interpolate -rl orig.mgz ' ...
            fullfile(PredictDir,'Volume', [map_name '.nii.gz'])...
            ' ' fullfile(PredictDir,'Volume', [map_name '_resliced.nii.gz']) ' --conform']);
        ...
        for p=1:length(proj_values)
            ...
            unix(['mri_vol2surf --mov ' fullfile(PredictDir,'Volume', [map_name '_resliced.nii.gz']) ...
