...
map_name = {'Group_lh_mOTS_morphing_reading_vs_all_proj_max_without_Subject_'};
...
for ss = 1:30 %the output subject
    ...
    out_dir = fullfile('/share/kalanit/biac2/kgs/projects/PredictFuncFromStruct/data4Predict',strcat('Subject_', num2str(ss)),'/GrpROIs');
    mkdir(out_dir)
    ...
    % transform surface files to fsaverage
        unix(['mri_surf2surf --srcsubject fsaverage-bkup --srcsurfval ' ...
            ...
            fullfile(out_dir,strcat(map_name{:},num2str(s),'.mgh')) ' --hemi lh --mapmethod nnf']); % left hemi
    end
end
