...
%                 ' --proj frac -1 1 0.1 --subject ' anat_id ' --temp ' fullfile(fs_dir,'mri','orig.mgz')]); % left hemi
                    ...
                    unix(['mri_label2vol --label ' fullfile('/share/kalanit/biac2/kgs/projects/PredictFuncFromStruct/data4Predict',strcat('Subject_',num2str(ss)),'ROIs', [label_names{mm},'.label']) ...
                ' --regheader ' fullfile(fs_dir,'mri','orig.mgz') ' --fill-ribbon --hemi lh --o ' ...
                fullfile(anat_dir,'niftiRois',strcat(label_names{mm}, '.nii.gz'))...
                ' --proj frac -1 1 0.1 --subject ' anat_id ' --temp ' fullfile(fs_dir,'mri','orig.mgz')]); % left hemi
