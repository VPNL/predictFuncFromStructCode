...
map_name = {'lh_mOTS_morphing_reading_vs_all_disk_7mm_proj_max'};
...
for ss = 1:30
    ...
    map_dir = fullfile('/share/kalanit/biac2/kgs/projects/PredictFuncFromStruct/data4Predict',strcat('Subject_', num2str(ss)),'/ROIs');
    ...
    unix(['mri_surf2surf --srcsubject ' fs_id ' --srcsurfval ' ...
        ...
        fullfile(outdir,strcat('Subject_',num2str(ss),'_',map_name{:},'.mgh')) ' --hemi lh --mapmethod nnf']); % left hemi
end
